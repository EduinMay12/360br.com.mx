...
class DepartamentoController extends Controller
{
    public function index()
    {
        ...
        return view('ventas.departamento.index',compact('header','departamentos'));
    }

    public function show(Departamento $departamento)
    {
        $header = Header::all();
        return view('ventas.departamento.show',compact('header', 'departamento'));
    }
    ...
    {
        $header = Header::all();
        return view('departamento.create',compact('header'));
    }
