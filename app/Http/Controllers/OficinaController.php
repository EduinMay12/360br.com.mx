...
class OficinaController extends Controller
{
    public function index()
    {
        ...
        $header = Header::all();
        return view('ventas.oficina.index',compact('oficinas','header'));
    }

    public function show(Oficina $oficina)
    {
        $header = Header::all();
        return view('ventas.oficina.show',compact('header', 'oficina'));
    }
    ...
    {
        $header = Header::all();
        return view('oficina.create',compact('header'));
    }
