<div class="container py-7">
  <div class="row mt-3">
    <div class="col-sm-4 col-6 mx-auto">
      ...
      <!-- Modal -->
      <div class="modal fade" id="exampleModalOficina" tabindex="-1" aria-labelledby="exampleModalOficinaLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalOficinaLabel">Agregar nueva Oficina en venta</h5>
            ...
            @endif
            <form action="{{ route('oficina.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
