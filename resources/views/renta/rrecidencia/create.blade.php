<div class="container py-7">
  <div class="row mt-3">
    <div class="col-sm-4 col-6 mx-auto">
      ...
      <!-- Modal -->
      <div class="modal fade" id="exampleModalRecidencia" tabindex="-1" aria-labelledby="exampleModalRecidenciaLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalRecidenciaLabel">Agregar nueva recidencia en venta</h5>
            ...
            @endif
            <form action="{{ route('recidencia.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
