      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 ms-lg-5">
            <h1 class="text-white">Venta de Propiedades y Casas</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  @can('Crear Lotes')
    ...
    <a href="{{ route('casas.create') }}" class="btn bg-gradient-success w-auto" data-bs-toggle="modal" data-bs-target="#exampleModalCasas">
