<div class="container py-7">
  <div class="row mt-3">
    <div class="col-sm-4 col-6 mx-auto">
      ...
      <!-- Modal -->
      <div class="modal fade" id="exampleModalCasas" tabindex="-1" aria-labelledby="exampleModalCasasLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalCasasLabel">Agregar nueva propiedad en venta</h5>
