      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 ms-lg-5">
            <h1 class="text-white">Venta Recidencial</h1>
          </div>
        </div>
      </div>
    </div>
  ...
  @can('Crear Lotes')
    ...
    <a href="{{ route('recidencia.create') }}" class="btn bg-gradient-success w-auto" data-bs-toggle="modal" data-bs-target="#exampleModalRecidencia">
