<div class="container py-7">
  <div class="row mt-3">
    <div class="col-sm-4 col-6 mx-auto">
      ...
      <!-- Modal -->
      <div class="modal fade" id="exampleModalTERRENO" tabindex="-1" aria-labelledby="exampleModalTERRENOLabel" aria-hidden="true">
        <div class="modal-dialog">
          <div class="modal-content">
            <div class="modal-header">
              <h5 class="modal-title" id="exampleModalTERRENOLabel">Agregar nuevo Lote</h5>
            ...
            @if ($errors->any())
                <div class="alert alert-danger">
                    <strong>UUps!</strong> Hubo algunos problemas con su entrada. <br><br>
                    <ul>
                ...
                @csrf
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                            ...
                            <textarea type="text" name="descripcion" class="form-control" placeholder="Pequeña descripción" required></textarea>
                        </div>
                    </div>
                    <div class="col-xs-12 col-sm-12 col-md-12">
                        <div class="form-group">
                    ...
                    <hr>
                    <h6 class="form-label text-center" for="">Caracteristicas</h6>
                    ...
                    <div class="row">
                        ...
                        <div class="col-xs-4 col-sm-4 col-md-4">
                            <div class="form-group">
                                <label class="form-label" for="">Area de Lavado :</label>
